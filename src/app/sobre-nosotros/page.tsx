  ...
  return(
    <>
      <section className="relative bg-[url('/banner.jpg')] h-[80dvh] max-h-[900px] bg-cover bg-fixed flex justify-center items-center text-white">
        ...
        <h1 className="z-20 font-bold text-6xl container mx-auto text-shadow-lg">Laramed: Importadora y Distribuidora de Equipos Médicos en Bolivia</h1>
      </section>  
      ...
      <section className='container mx-auto grid md:grid-cols-2 place-items-center gap-10 my-22'>
        <div>
